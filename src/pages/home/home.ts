...
export class HomePage {
    capitao = 'assets/capitao.jpg'
    homemFerro = 'assets/homemFerro.jpg'
    thor = 'assets/thor.jpg'
    pantera = 'assets/pantera.jpg'
    viuva = 'assets/viuva.jpeg'
    gaviao = 'assets/gaviao.jpeg'
    soldadoInvernal = 'assets/soldadoInvernal.jpg'
    homemAranha = 'assets/homemAranha.jpg'
    hulk = 'assets/hulk.jpg'
    visao = 'assets/visao.jpg'
    falcao = 'assets/falcao.jpg'
    doutorEstranho = 'assets/doutorEstranho.jpg'
        ...
        function Particles(element, options) {
          ...
          Particles.prototype = {
            defaults: {
              ...
              size: 10,
              speed: 3,
              particlesAmountCoefficient: 2.5,
          ...
          this.items.forEach((el, pos) => {
            ...
            const bttnBack = el.querySelector('button.action');
              ...
              let particlesOpts = this.arrOpts[pos];
